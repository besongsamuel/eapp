...
/* Globals */
defined('ASSETS_PATH')              OR define('ASSETS_PATH', 'http://'.$_SERVER['HTTP_HOST'].'/assets/'); // The assets folder of the application
defined('ASSETS_DIR_PATH')          OR define('ASSETS_DIR_PATH', $_SERVER['DOCUMENT_ROOT'].'/assets/'); // The assets folder of the application

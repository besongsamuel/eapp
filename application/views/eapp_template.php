            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="pull-left header-social">
                        <a href="https://www.facebook.com/otiprix.otiprix.1" target="_blank"><i class="md-primary" class="fa fa-facebook"></i></a>
                        <a href="https://twitter.com/otiprix" target="_blank"><i class="md-primary" class="fa fa-twitter"></i></a>
                        <a href="https://www.youtube.com/channel/UCbwxS8s1WKYgGCRzd9vIl5A" target="_blank"><i class="md-primary" class="fa fa-youtube"></i></a>
                        <a ng-hide="true" href="https://www.instagram.com/otiprix/" target="_blank"><i class="md-primary" class="fa fa-instagram"></i></a>
                ...
                <div class="col-sm-6">
                    ...
                    <div ng-controller="AccountController">
                        ...
                        <div class="pull-right">
                            ...
                            <span>
                                <span style="color : rgba(0,0,0,0.54);"><b>Voir Panier</b></span>

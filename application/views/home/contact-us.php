<!DOCTYPE html>
    ...
    <div class="mainbox" ng-cloak>
        
        <div class="container">
            <div class="row contact-us-form" ng-controller="ContactUsController">
                        ...
                        <md-content class="contactus-box">
                            <form name="contactusForm" novalidate ng-submit="contactus()">
                                ...
                                <div class="col-sm-12">
                                    <md-input-container class="md-block" flex-gt-xs>
                                        <label>Sujet</label>
                                        <md-icon class="md-primary"><i class="material-icons">subject</i></md-icon>

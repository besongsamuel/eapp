                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            ...
                                            <div id="collapseOne2" class="accordion-body collapse">
                                                <div class="accordion-inner">
                                                    <p class="css">Otiprix recueille les prix directement auprès des principaux supermarchés. Les prix sont mis à jour chaque semaine, ce qui signifie que nous avons toujours toutes les dernières promotions disponibles pour nos utilisateurs. Pour économiser avec OtiPrix, le consommateur établit sa liste d’épicerie en utilisant les différentes catégories de produits ou en parcourant les circulaires des magasins ou encore, en utilisant l’outil de recherche. Par la suite Otiprix trouve en un seul clic le meilleur prix pour chaque produit en tenant compte des magasins les plus proches du consommateur. Otiprix présente à l’utilisateur les deux ou les trois magasins où il obtient le maximum de réduction pour toute sa liste d’épicerie. C’est simple et surtout très économique. Otiprix aide ainsi les consommateurs à économiser en moyenne 30 % à 40 % sur leur épicerie en comparant des milliers de produits et en proposant des alternatives moins chères. </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-group">
                                            <div class="accordion-heading">
                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseOne4">
                                                    <em class="fa fa-plus icon-fixed-width"></em>À qui s'adresse Otiprix?
                                                </a>
                                            </div>
                                            <div id="collapseOne4" class="accordion-body collapse">
                                                <div class="accordion-inner">
                                                    <p class="css">Tout le monde peut utiliser Otiprix. C’est simple et c’est gratuit. Plusieurs ménages utilisent régulièrement Otiprix pour économiser de l'argent sur leur épicerie. Si vous voulez économiser, c'est le site qu'il vous faut. </p>
                                                </div>
                                            </div>
                                        </div>

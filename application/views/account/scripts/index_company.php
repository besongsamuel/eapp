...
<script src="<?php echo base_url("assets/js/angular-controllers/company-stats-controller.js")?>"></script>
<script src="<?php echo base_url("assets/js/angular-controllers/upload-controller.js")?>"></script>
<script src="<?php echo base_url("assets/js/angular-controllers/tabs-controller.js")?>"></script>
...
<script src="<?php echo base_url("assets/js/angular-components/top-products.js")?>"></script>

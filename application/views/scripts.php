    ...
    <script src="<?php echo base_url("assets/js/angular-modules/vs-google-autocomplete.js")?>"></script>
    <script src="<?php echo base_url("assets/js/angular-modules/vs-autocomplete-validator.js")?>"></script>
    ...
    <!-- Angular Controllers -->
    <script src="<?php echo base_url("assets/js/angular-controllers/activate-account-controller.js")?>"></script>

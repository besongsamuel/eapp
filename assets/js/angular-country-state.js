    ...
    angular
        ...
        .directive("countryStateSelect", [ "$sce", function ($sce) {
		    ...
		    if(typeof attrs.stateClass !== 'undefined'){
                    ...
                    scope.state[38]="Quebec|Alberta|British Columbia|Manitoba|New Brunswick|Newfoundland|Northwest Territories|Nova Scotia|Nunavut|Ontario|Prince Edward Island|Saskatchewan|Yukon Territory";
                    ...
                    scope.state[56]="Camaguey|Ciego de Avila|Cienfuegos|Ciudad de La Habana|Granma|Guantanamo|Holguin|Isla de la Juventud|La Habana|Las Tunas|Matanzas|Pinar del Rio|Sancti Spiritus|Santiago de Cuba|Villa Clara";
                    ...
                    // Patch to put Canada and USA at the top of the list
                    scope.canada_states = scope.state[38];
                    scope.us_states = scope.state[239];
                    scope.state.splice(239, 1);
                    scope.state.splice(38, 1);
                    scope.state.splice(1, 0, scope.us_states);
                    scope.state.splice(1, 0, scope.canada_states);

...
;( function( window ) {
	...
	BoxesFx.prototype._init = function() {
		...
		// the panels
		this.panels = [].slice.call( this.el.querySelectorAll( '.panel1' ) );
		...
		this.nav.innerHTML = '<span class="prev"><i class="fa fa-angle-down"></i></span><span class="next"><i class="fa fa-angle-up"></i></span>';
